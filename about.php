                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="ttm_single_image-wrapper text-left">
                            <img class="img-fluid" src="images/img4.jpg" alt="single-09">
                        </div>
                    </div>
                ...
                <div class="row slick_slider mb_15  " data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "arrows":false, "autoplay":false, "dots":false, "infinite":true, "responsive":[{"breakpoint":992,"settings":{"slidesToShow": 2}},{"breakpoint":840,"settings":{"slidesToShow": 2}},{"breakpoint":650,"settings":{"slidesToShow": 1}}]}'>
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-services style1">
                            ...
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="images/img13.jpg" alt="image">
                            </div><!-- featured-thumbnail end-->
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3><a href="">Fabric Printing</a></h3>
                                    <div class="ttm-details-link">
                                        <a href=""><i class="themifyicon ti-arrow-top-right"></i></a>
                                    </div>
                                </div>
                                <div class="featured-desc">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-services style1">
                            <!-- featured-thumbnail -->
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="images/img12.jpg" alt="image">
                            </div><!-- featured-thumbnail end-->
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3><a href="">Fabric Dyeing</a></h3>
                                    <div class="ttm-details-link">
                                        <a href=""><i class="themifyicon ti-arrow-top-right"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-services style1">
                            <!-- featured-thumbnail -->
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="images/img7.jpg" alt="image">
                            </div><!-- featured-thumbnail end-->
                            <div class="featured-content">
                                <div class="featured-title">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 ml-auto">
                        <div class="ttm-bg ttm-col-bgimage-yes col-bg-img-eight ttm-bg ttm-col-bgcolor-yes ttm-bgcolor-skincolor res-991-margin_bottom15">
                                ...
                                <div class="slick_slider" data-slick='{"slidesToShow": 1, "slidesToScroll": 1, "arrows":false, "autoplay":false, "dots":false, "infinite":true, "responsive":[{"breakpoint":992,"settings":{"slidesToShow": 1}},{"breakpoint":840,"settings":{"slidesToShow": 1}}]}'>
                                    ...
                                    <div class="testimonials ttm-testimonial-box-view-style3">
                                        <div class="testimonial-content">
                                            <blockquote class="testimonial-text">Annapoorani Textiles 's customer service is great. I was searching &amp; found exactly what I wanted, was delivered quickly. Very good transaction. Fast shipping. Great blankets fabric and I am planning to buy it in bulk order.</blockquote>
                                    ...
                                    <div class="testimonials ttm-testimonial-box-view-style3"> 
                                        <div class="testimonial-content">
                                            <blockquote class="testimonial-text">The culture is the best at Annapoorani Textiles . You can tell that they truly care about the happiness of their employees. It's a really relaxed and calm environment and their quality of product is always best. I refer them for the future.</blockquote>
                                            <div class="testimonial-bottom">
                                                <div class="testimonial-avatar">
                                                    <div class="testimonial-img">
                                    ...
                                    <div class="testimonials ttm-testimonial-box-view-style3"> 
                                        <div class="testimonial-content">
                                            <blockquote class="testimonial-text">I realized after I sent in my order that I had ordered a larger quantity than I needed. I emailed and received a quick response, adjustment to my order and a refund. Product was shipped out  in a timely manner. Annapoorani Textiles  is great!</blockquote>
                                            <div class="testimonial-bottom">
                                                <div class="testimonial-avatar">
                                                    <div class="testimonial-img">
                ...
                <!-- <div class="row"> -->
                    <!-- <div class="col-lg-12"> -->
                        ...
                        <!-- <div class="section-title style2"> -->
                            ...
                            <div class="title-desc">
                                <p>Since more than 40 years, Annapoorani Textiles  is operating in the textile market manufacture and trader. As years go by, the range of produced textiles has been increased.</p>
                            </div> -->
                        <!-- </div>section title end -->
                    <!-- </div>
                </div>
                    ...
                    <div class="col-lg-4"> -->
                        ...
                        <!-- <div class="featured-imagebox featured-imagebox-post style1">
                            ...
                            <div class="featured-content"> -->
                                ...
                                <div class="featured-title">
                                    <h3><a href="">Can textiles lead the way during the pandemic?</a></h3>
                                </div>
                                <div class="featured-desc">
                    ...
                    <!-- <div class="col-lg-4"> -->
                        ...
                        <!-- <div class="featured-imagebox featured-imagebox-post style1">
                            ...
                            <div class="featured-content"> -->
                                ...
                                <!-- </div>post-meta end -->
                                <!-- <div class="featured-title">
                                    <h3><a href="">One stop solution for textiles fabrics</a></h3>
                                </div>
                                <div class="featured-desc">
                    ...
                    <div class="col-lg-4"> -->
                        ...
                        <!-- <div class="featured-imagebox featured-imagebox-post style1">
                            ...
                            <div class="featured-content"> -->
                                ...
                                <!-- </div>post-meta end -->
                                <!-- <div class="featured-title"> -->
                                    <!-- <h3><a href="">Textilegence Magazine & Digital Platform</a></h3> -->
                                <!-- </div> -->
                                <!-- <div class="featured-desc"> -->
                                    <!-- <p>Enim nunc faucibus a pellentesque sit amet porttitor eget. Morbi blandit cursus risus...</p> -->
                                <!-- </div> -->
                                <!-- <a class="ttm-btn ttm-btn-size-md ttm-btn-color-dark btn-inline" href="" tabindex="-1">read more</a> -->
                            <!-- </div> -->
                        <!-- </div>featured-imagebox-post end -->
                    <!-- </div> -->
                    <!-- <div class="col-lg-4"> -->
                        ...
                        <!-- <div class="featured-imagebox featured-imagebox-post style1">
                            ...
                            <div class="featured-content"> -->
                                ...
                                <!-- <div class="featured-title"> -->
                                    <!-- <h3><a href="">Contactless Payments Time Has Come</a></h3> -->
                                <!-- </div> -->
                                <!-- <div class="featured-desc"> --> 
...
<!-- Mirrored from themetechmount.com/html/Annapoorani Textiles /about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 May 2022 10:13:15 GMT -->
</html>